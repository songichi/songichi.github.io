...
var hanziGroupList = [
    ...
    [new zi("會", 3, "會"), new zi("亽", 3, "會"), new zi("会", 13, "會")],
    [new zi("其", 8, "其"), new zi("丌", 3, "其")],
    [new zi("着", 11, "着"), new zi("丆", 2, "着")],
    [new zi("的", 8, "的"), new zi("勹", 3, "的")],
    [new zi("得", 11, "得"), new zi("丷", 2, "得")],
    [new zi("有", 6, "有"), new zi("屮", 3, "有")],
    [new zi("到", 8, "到"), new zi("ㄥ", 3, "到")],
    [new zi("我", 7, "我"), new zi("ㄙ", 2, "我")],
    [new zi("卻", 9, "卻"), new zi("ㄗ", 2, "卻")],
    ...
    [new zi("他", 5, "他"), new zi("ㄔ", 2, "他")],
    [new zi("在", 6, "在"), new zi("ナ", 2, "在")],
    [new zi("再", 6, "再"), new zi("冄", 4, "再")],
    [new zi("能", 10, "能"), new zi("厸", 4, "能")],
    [new zi("要", 9, "要"), new zi("ヌ", 2, "要")],
    [new zi("過", 11, "過"), new zi("ㄋ", 2, "過")],
    [new zi("從", 11, "從"), new zi("从", 4, "從")],
    [new zi("們", 10, "們"), new zi("冂", 2, "們"), new zi("们", 5, "們")],
    [new zi("和", 8, "和"), new zi("丿", 1, "和")],
    [new zi("裏", 13, "裏"), new zi("亠", 2, "裏")],
    [new zi("地", 6, "地"), new zi("乚", 1, "地")],
    [new zi("所", 8, "所"), new zi("ㄕ", 3, "所")],
    [new zi("次", 6, "次"), new zi("ソ", 2, "次")],
    [new zi("來", 8, "來"), new zi("丯", 4, "來")],
    [new zi("都", 11, "都"), new zi("耂", 4, "都")],
    [new zi("像", 13, "像"), new zi("", 2, "像")],
    [new zi("後", 9, "後"), new zi("乆", 3, "後")],
    [new zi("沒", 7, "沒"), new zi("氵", 3, "沒")],
    [new zi("算", 14, "算"), new zi("廾", 3, "算")],
    [new zi("給", 12, "給"), new zi("亼", 3, "給")],
    [new zi("點", 17, "點"), new zi("灬", 4, "點"), new zi("点", 9, "點")],
    [new zi("如", 6, "如"), new zi("ㄣ", 1, "如")],
];

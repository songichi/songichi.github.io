...
//data for types
typeGroupList = [
    new typeObject(["hanzi"], "相思", "type/xiangsi.png", true, "#F5E2B3", "#8F2E4C", "紅豆生南國、春來發幾枝", "———『相思』王維", new Date(2023, 0, 27, 21, 25, 0, 0)),
    ...
    new typeObject(["hanzi"], "國殤", "type/guoshang.png", true, "#11f7af", "#000000", "操吳戈兮被犀甲，車錯轂兮短兵接", "———『國殤』屈原", new Date(2022, 9, 4, 0, 0, 0, 0)),
];

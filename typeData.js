...
typeGroupList = [
    ...
    new typeObject(["latin"], "INFERNO", "type/inferno.png", false, "#f44914", "#000000", "inferno inferno", "———『Divine Comedy』Dante", new Date(2022, 10, 20, 0, 0, 0, 0)),
    ...
    new typeObject(["latin"], "HAMLET", "type/hamlet.png", false, "#f9e532", "#000000", "To be or not to be, that is the questions", "———『Hamlet』William Shakespeare", new Date(2022, 10, 4, 0, 0, 0, 0)),
    new typeObject(["hanzi", "kana"], "吾輩は猫である", "type/wagahai.png", false, "#ed6d03", "#ffffff", "吾輩は猫である", "———『吾輩は猫である』夏目漱石", new Date(2022, 10, 4, 0, 0, 0, 0)),

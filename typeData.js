...
typeGroupList = [
    ...
    new typeObject(["hanzi"], "雲中君", "type/yunzhongjun.png", true, "#FFE0F2", "#1634B8", "思夫君兮太息、極勞心兮忡忡", "———『楚辭*九歌*雲中君』屈原", new Date(2022, 9, 28, 0, 0, 0, 0)),
    new typeObject(["hanzi"], "山鬼", "type/shangui.png", true, "#29211D", "#F8FCEA", "若有人兮山之阿、披薜荔兮戴女羅", "———『楚辭*九歌*山鬼』屈原", new Date(2022, 9, 24, 0, 0, 0, 0)),
    new typeObject(["hanzi"], "無衣", "type/wuyi.png", true, "#0A3470", "#FFEF45", "豈曰無衣、與子同袍", "———『無衣』詩經·秦風", new Date(2022, 9, 24, 0, 0, 0, 0)),

...
for (var i = 0; i < TypeList.length; i++) {
    try {
        ...
        a.querySelector(".typeTitle").style.color =
            matchingType.colorS;
        a.querySelector(".typeQuote").style.color =
            matchingType.colorS;
        a.querySelector(".typeSource").style.color =
            matchingType.colorS;
...
function addEventListenersToBtn(btn, key, bool) {
    //add click function
